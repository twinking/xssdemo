...
<div class="limiter">
    <div class="container-login100" style="background-image: url('${ctxStatic}/main/images/bg-01.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form class="login100-form validate-form" method="post" action="${ctx}/index/registe.do" onsubmit="return checkFrom()">
                ...
                <div class="flex-col-c p-t-25">
                    <a href="${ctx}/webpage/index.jsp" class="txt2">转到登录</a>
                </div>
            </form>
        </div>
    </div>
