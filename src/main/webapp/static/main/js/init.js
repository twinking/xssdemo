...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			global: {
				href: root + '/static/main/css/style.css',
				grid: {
					gutters: ['2.5em', 0]
				}
			},
			xlarge: {
				...
				href: root + '/static/main/css/style-xlarge.css'
			},
			large: {
				media: '(max-width: 1280px)',
				href: root + '/static/main/css/style-large.css',
				grid: {
					gutters: ['2em', 0]
				}
			},
			medium: {
				...
				href: root + '/static/main/css/style-medium.css'
			},
			small: {
				media: '(max-width: 736px)',
				href: root + '/static/main/css/style-small.css',
				grid: {
					gutters: ['1.5em', 0],
					zoom: 2
				},
			...
			xsmall: {
				...
				href: root + '/static/main/css/style-xsmall.css',
				grid: {
					zoom: 3
				}
			}
